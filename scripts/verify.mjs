...
const checks = [
  ...
  ['weather/environment present', js.includes('api.open-meteo.com') && js.includes('temperature_unit=fahrenheit') && js.includes('°F') && js.includes('UV index')],
  ['today ask dropdown present', js.includes('askSelect') && js.includes('Pick up to 3 things for today')],
  ['dropdown goal/activity/workout selectors present', js.includes('goalPick') && js.includes('activityPick') && js.includes('workoutPick')],
  ['GPS route tracker present', js.includes('watchPosition') && js.includes('routeMiles') && js.includes('tile.openstreetmap.org') && js.includes('estimateSteps')],
  ['route editing present', js.includes('editRoute') && js.includes('Add manual point')],
  ['muscle map present', js.includes('realistic muscle map') && js.includes('data-muscle')],
